...
std::shared_ptr<shimmer::fbo> shimmer::gl_resource_manager::get_fbo ( const std::string& id )
{
        return std::make_shared<shimmer::fbo>();
}

std::shared_ptr<shimmer::font> shimmer::gl_resource_manager::get_font ( const std::string& id )
{
        return std::make_shared<shimmer::font>();
}

std::shared_ptr<shimmer::material> shimmer::gl_resource_manager::get_material ( const std::string& id )
{
        return std::make_shared<shimmer::material>();
}

std::shared_ptr<shimmer::mesh> shimmer::gl_resource_manager::get_mesh ( const std::string& id )
{
        return std::make_shared<shimmer::mesh>();
}
std::shared_ptr<shimmer::model> shimmer::gl_resource_manager::get_model ( const std::string& id )
{
        return std::make_shared<shimmer::model>();
}

std::shared_ptr<shimmer::shader> shimmer::gl_resource_manager::get_shader ( const std::string& id )
{
        return std::make_shared<shimmer::shader>();
}

std::shared_ptr<shimmer::texture> shimmer::gl_resource_manager::get_texture ( const std::string& id )
{
