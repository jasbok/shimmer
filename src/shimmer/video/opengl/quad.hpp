...
public:
        ...
        void aspect_ratio ( const dimensions<GLfloat>& ratio, bool flip_y = false);
        void shape ( const rectangle<coordinates<GLfloat>, dimensions<GLfloat>> rect, bool flip_y = false);
        void shape ( GLfloat x, GLfloat y, GLfloat w, GLfloat h, bool flip_y = false);
