...
void text_renderer::draw (
    std::string text,
    const coordinates<GLfloat>& coords )
{
...
text_renderer& text_renderer::shader (
...
text_renderer& text_renderer::colour ( const glm::vec4& colour )
{
    _colour = colour;
    _shader->use_program()
    .set_uniform ( "colour", _colour );
...
text_renderer& text_renderer::resolution (
    const dimensions<GLfloat>& resolution )
{
