...
void shimmer::opengl_renderer::source_format ( const dimensions<>& dims, unsigned int bpp, shimmer::pixel_format format, shimmer::pixel_type type )
{
        ...
        glFramebufferTexture2DEXT ( GL_FRAMEBUFFER_EXT, GL_COLOR_ATTACHMENT0_EXT, GL_TEXTURE_2D, _source_texture->gl_texture(), 0 );
        glBindFramebufferEXT ( GL_FRAMEBUFFER_EXT, 0 );
}

void shimmer::opengl_renderer::bind_source_texture_unit()
{
        glActiveTexture ( GL_TEXTURE0 );
}

void shimmer::opengl_renderer::bind_source_fbo()
{
        glBindFramebufferEXT ( GL_FRAMEBUFFER_EXT, _source_fbo );
}
...
//                 printf ( "FBO Complete Status: GL_FRAMEBUFFER_UNDEFINED.\n" );
//                 break;
//         case GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT:
//                 printf ( "FBO Complete Status: GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT.\n" );
//                 break;
//         case GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT:
//                 printf ( "FBO Complete Status: GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT.\n" );
//                 break;
//         case GL_FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER:
//                 printf ( "FBO Complete Status: GL_FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER.\n" );
//                 break;
//         case GL_FRAMEBUFFER_INCOMPLETE_READ_BUFFER:
//                 printf ( "FBO Complete Status: GL_FRAMEBUFFER_INCOMPLETE_READ_BUFFER.\n" );
//                 break;
//         case GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE:
//                 printf ( "FBO Complete Status: GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE.\n" );
//                 break;
//         case GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS:
//                 printf ( "FBO Complete Status: GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS .\n" );
//                 break;
//         case GL_FRAMEBUFFER_UNSUPPORTED:
//                 printf ( "FBO Complete Status: GL_FRAMEBUFFER_UNSUPPORTED.\n" );
//                 break;
//         case GL_FRAMEBUFFER_COMPLETE:
//                 printf ( "FBO Complete Status: GL_FRAMEBUFFER_COMPLETE.\n" );
//                 break;
//         default:
//                 printf ( "FBO Complete Status: An error occured while checking the framebuffer status.\n");
//                 break;
//         }
