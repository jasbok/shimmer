...
public:
    ...
    void pixels (
        ...
        dimensions<unsigned int>>& rect ) override;
    ...
    void background_shaders (
        const std::vector<std::string>& vertex_shaders,
        const std::vector<std::string>& fragment_shaders ) override;

    void foreground_shaders (
        const std::vector<std::string>& vertex_shaders,
        const std::vector<std::string>& fragment_shaders ) override;
    ...
    void font (
        ...
        const std::string& bold, unsigned int size ) override;
